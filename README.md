...
Todly is a lightweight Windows desktop productivity companion that helps you stay on top of your commitments across **four time horizons**: Daily, Weekly, Quarterly, and Yearly. Built with Flutter and Hive for a native, always-available experience.
...
- **Quick add** - Spotlight-style dialog with suffix parsing: `"Pay invoice w"` becomes a weekly task.
- **Reactive state** - Changes in any view reflect instantly everywhere via Riverpod.
- **Customizable overlay** - Adjust corner position, opacity, hover delay, and streak visibility from Settings.
...
git clone https://github.com/yourusername/todly.git
cd todly
...
The release executable will be at `build\windows\x64\runner\Release\todly.exe`.
...
lib/
  ...
  app.dart                      MaterialApp with Todly theme
